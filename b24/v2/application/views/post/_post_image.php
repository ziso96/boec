...
<?php if (isset($post_item)):
	...
	if (!empty($post_item->image_url) || $post_item->image_mime == 'gif' || $post_item->post_type == 'video'):?>
		<div class="external-image-container">
			...
			<?php endif; ?>
			<img src="<?php echo $bg; ?>" class="card-img-top img-fluid" alt="<?php echo html_escape($post_item->title); ?>">
			<img src="<?php echo $bg; ?>" data-src="<?php echo $img_url; ?>" alt="<?php echo html_escape($post_item->title); ?>" class="card-img-top img-fluid" onerror='<?php echo $bg; ?>'>
		</div>
	<?php else: ?>
		<img src="<?php echo $bg; ?>" data-src="<?php echo $img_url; ?>" class="lazyload card-img-top img-fluid" alt="<?php echo html_escape($post_item->title); ?>" onerror="javascript:this.src='<?php echo $bg; ?>'">
	<?php endif;
endif; ?>
