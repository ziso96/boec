...
<head>
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>v2/app-assets/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>v2/app-assets/css/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>v2/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
                ...
                <div class="auth-inner my-2">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <h4 class="card-title mb-1"><?php echo trans("login"); ?> - <?php echo trans("admin"); ?></h4>
                            ...
                            <form class="auth-login-form mt-2" action="index.html" method="POST">
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" id="login-email" name="username" value="<?php echo html_escape(old('username')); ?>" placeholder="<?php echo trans("username_or_email"); ?>" aria-describedby="login-email" tabindex="1" autofocus required <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>/>
                                </div>

                                <div class="mb-1">
                                    <div class="d-flex justify-content-between">

                                        <label class="form-label" for="login-password"><?php echo trans("password"); ?></label>
                                        <a href="<?php echo lang_base_url(); ?>forgot-password">
                                            <small><?php echo trans("forgot_password"); ?>?</small>
                                        </a>
                                    </div>
...
<script src="<?php echo base_url(); ?>v2/app-assets/vendors/js/forms/validation/jquery.validate.min.js"></script>
<!-- END: Page Vendor JS-->
...
<!-- BEGIN: Page JS-->
<script src="<?php echo base_url(); ?>v2/app-assets/js/scripts/pages/auth-login.js"></script>
<!-- END: Page JS-->
