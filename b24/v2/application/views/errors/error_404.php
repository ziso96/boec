...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>v2/app-assets/css/pages/page-misc.css">
    <!-- END: Page CSS-->
...
<div class="app-content content ">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            <!-- Error page-->
            <div class="misc-wrapper"><a class="brand-logo" href="<?php echo lang_base_url(); ?>">
                ...
                <div class="misc-inner p-2 p-sm-3">
                    <div class="w-100 text-center">
                        <h2 class="mb-1">404 - <?php echo trans("page_not_found"); ?> 🕵🏻‍♀️</h2>
                        <p class="mb-2"><?php echo trans("page_not_found_sub"); ?>😖</p>
                        <a class="btn btn-primary mb-2 btn-sm-block" href="<?php echo lang_base_url(); ?>"><?php echo trans("go_to_home"); ?></a> <br>
                        <img style="zoom: 80%" class="img-fluid" src="<?php echo base_url(); ?>v2/app-assets/images/pages/error.svg" alt="Error page" />
                    </div>
                </div>
            </div>
            <!-- / Error page-->
